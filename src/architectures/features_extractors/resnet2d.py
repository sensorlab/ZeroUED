...
def ResNet2D(pretrained=False, **kwargs):
...
def ResNet2D_34(pretrained=False, **kwargs):
...
def ResNet2D_50(pretrained=False, **kwargs):
...
def ResNet2D_101(pretrained=False, **kwargs):
...
def ResNet2D_152(pretrained=False, **kwargs):
